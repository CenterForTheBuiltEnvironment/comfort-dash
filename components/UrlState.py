...
class UrlState:
    ...
    def setup_dash_callbacks(app):
        ...
        def update_url(*args):
            ...
            if pathname == '/single':
                ...
                inputs = args[1]
                input_ids = args[6]
                params = {id['index']: value for id, value in zip(input_ids, inputs) if value is not None}
                ...
                set1_ids = args[7]
                set2_ids = args[8]
                set1 = {id['index']: value for id, value in zip(set1_ids, set1_inputs) if value is not None}
                set2 = {id['index']: value for id, value in zip(set2_ids, set2_inputs) if value is not None}
                ...
                range_inputs = args[5]
                range_ids = args[10]
                range_params = {id['index']: value for id, value in zip(range_ids, range_inputs) if value is not None}
    ...
    def get_current_values_from_dash(values, ids):
        ...
        return {id_dict['index']: value for id_dict, value in zip(ids, values) if value is not None}
