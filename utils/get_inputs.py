...
from utils.my_config_file import Functionalities, Models, UnitSystem, UnitConverter, convert_units, ElementsIDs
...
def get_inputs(
    ...
    if functionality_selection == Functionalities.Compare.value and selected_model in [
        ...
        list_model_inputs2 = list(Models[selected_model].value.inputs)
