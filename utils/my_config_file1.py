...
class Input():
    ...
    FANS_AND_HEAT: str = "Fans and Heat Chart"
    ...
    #pmv ashare result card: output
    ASHARE_RESULT_CARD_1: str = "PMV = -0.16"
    ASHARE_RESULT_CARD_2: str = "PPD = 6 %"
    ASHARE_RESULT_CARD_3: str = "Sensation = Neutral"
    ASHARE_RESULT_CARD_4: str = "SET = 24.8 °C"

    # pmv en result card: output 
    PMV_RESULT_CARD_1: str = "PMV = -0.16"
    PMV_RESULT_CARD_2: str = "PPD = 6 %"
    PMV_RESULT_CARD_3: str = "SET = |"

    #phs result card: output 
    PHS_RESULT_CARD_1: str = (
    ...
    PHS_RESULT_CARD_2: str = "max rectal temperature = 53 min"
    PHS_RESULT_CARD_3: str = "water loss of 5% of the body mass for 95% of the population = 256 min"
    PHS_RESULT_CARD_4: str = "water loss of 7.5% of the body mass for an average person = 380 min"

    # Adaptive Ashare Speeds: output 
    SPEED_ADAPTIVE_ASHARE_1: str = "0.3 m/s (59fpm)"
    SPEED_ADAPTIVE_ASHARE_2: str = "0.6 m/s (118fpm)"
    SPEED_ADAPTIVE_ASHARE_3: str = "0.9 m/s (177fpm)"
    SPEED_ADAPTIVE_ASHARE_4: str = "1.2 m/s (236fpm)"

    #Adpative EN Speeds: output
    SPEED_EN_SLECTION_1: str = "lower than 0.6 m/s (118fpm)"
    SPEED_EN_SLECTION_2: str = "0.6 m/s (118fpm)"
    SPEED_EN_SLECTION_3: str = "0.9 m/s (177fpm)"
    SPEED_EN_SLECTION_4: str = "1.2 m/s (236fpm)"

    #speed local control selectioin: output 
    NO_LOCAL_CONTROL: str = "No local control"
    WITH_LOCAL_CONTROL: str = "with local control"

    #humidity selection: output 
    ...
    #operative temperature: output 
    o_1: str = "Use operative temp"
    
    #chart desrciption: output 
    note: str = "NOTE:"
